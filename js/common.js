...
// var key = CryptoJS.enc.Utf8.parse("ycjffollowsmoney");
// var iv = CryptoJS.enc.Utf8.parse('yenomfollowsfjcy');
...
//     var srcs2 = JSON.stringify(word).replace(/"/g, '')
...
(function() {
    ...
    function Cmd(cmd, params, token_o, userId_o) {
        this.cmd = cmd;
        this.token = token_o;
        this.version = 1;
        this.userId = userId_o;
        if (params != null) {
